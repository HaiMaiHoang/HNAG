...
function addMarker(place) {
  ...
  if (place.name === "Quán Cơm Niêu Mỗ Lao") {
    popup.innerHTML = `
      ...
      <div class="description">Quán cơm Việt phong cách gia đình, nổi tiếng với món cơm niêu, canh chua cá, và thịt kho tàu.</div>
      ...
      <div class="review-section">
        ...
        <div class="review-detail">
          <strong>Anonymous đã đánh giá Phở Tím</strong><br>
          ⭐⭐⭐⭐⭐<br>
    ...
    document.getElementById('btn-visit-website').onclick = () => {
      ...
      window.open('https://example.com/quancomnieu', '_blank');
    };
  } else {
    popup.innerHTML = `
      <h3>${place.name}</h3>
